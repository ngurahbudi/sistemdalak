        ...
        <div class="col-xs-12">
          <div class="box  box-primary">
            ...
            <div class="box-body" id="boxadd"  >
            	 <!-- form start -->
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>kecamatan/add" >
              <div class="box-body">
                 <div class="form-group">
                    <label for="txtkecamatan" class="block col-sm-2 control-label">Kecamatan ID</label>
                    	<div class="col-sm-6">
                    		<span class="block  ">
                        		<input name="txtID"   type="text" class="form-control" id="txtID" placeholder="Kecamatan ID" />
                    		</span>
                    	</div>
                    </label>
                </div> 
                 ...
                 <div class="form-group">
                    <label for="txtkecamatan" class="block col-sm-2 control-label">Kecamatan</label>
                    	<div class="col-sm-6">
                    		<span class="block  ">
                        		<input name="txtkecamatan"   type="text" class="form-control" id="txtkecamatan" placeholder="Kecamatan" />
                    		</span>
                    	</div>
                    </label>
                </div> 
