          ...
          <div class="box  box-default">
            ...
            <div class="box-body" id="boxlist" >
              <table width="" class="table table-bordered table-striped table-hover" id="datatabel">
                <thead>
                <tr>
                  <th width="70">Kecamatan ID</th>
                  <th width="337">Kecamatan</th>
                ...
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['kecamatan_id']; ?></td>
                  <td><? echo $row['kecamatan']; ?></td>
                  <td align="center"><? echo anchor('kecamatan/edit/'.$row['kecamatan_id']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('kecamatan/delete/' .$row['kecamatan_id'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                 </td>
