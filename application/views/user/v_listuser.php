          ...
          <div class="box  box-default">
            ...
            <div class="box-body" id="boxlist" >
              <table width="" class="table table-bordered table-striped table-hover" id="datatabel">
                <thead>
                <tr>
                  <th width="76">User ID</th>
                  <th width="288"> Nama User</th>
                  <th width="380"> Group</th>
                ...
                <tr>
                  ...
                  <td><? echo $row['usernama']; ?></td>
                  <td><? echo $row['groupuser']; ?></td>
                  <td align="center"><? echo anchor('user/edit/'.$row['userid']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('user/delete/' .$row['userid'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
