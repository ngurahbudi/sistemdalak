      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box  box-default">
            ...
            <div class="box-body"   >
            <form class="form-horizontal" method="post" id="form1" name="form1"  action="<? echo base_url() ?>Laptenggangwaktu/search" >
               
               <div class="form-group">
                      <label for="txttglturun" class="block col-sm-2 control-label">Tgl.Tempo mulai</label>
                      <div class=" col-sm-2" >
                ...
                <div class="form-group">
                      <label for="txttglturun2" class="block col-sm-2 control-label">Tgl.Tempo sampai</label>
                      <div class=" col-sm-2" >
                            <div class="input-group">
