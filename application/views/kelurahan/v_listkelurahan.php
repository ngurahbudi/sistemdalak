      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box  box-default">
            ...
            <div class="box-body" id="boxlist" style="overflow-x:auto;">
              <table width="" class="table table-bordered table-striped table-hover" id="datatabel">
                <thead>
                <tr>
                  <th width="76">Group ID</th>
                  <th width="288"> Kelurahan</th>
                  <th width="380"> Kecamatan</th>
                  <th width="31" align="center">Aksi</th>
                </tr>
                </thead>
                <tbody>
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['kelurahan_id']; ?></td>
                  <td><? echo $row['kelurahan']; ?></td>
                  <td><? echo $row['kecamatan']; ?></td>
                  <td align="center"><? echo anchor('kelurahan/edit/'.$row['kelurahan_id']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('kelurahan/delete/' .$row['kelurahan_id'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
