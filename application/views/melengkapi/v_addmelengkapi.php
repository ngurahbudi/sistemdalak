        ...
        <div class="col-xs-12">
          <div class="box  box-primary">
            ...
            <div class="box-body" id="boxadd"  >
            	 <!-- form start -->
            <form class="form-horizontal" method="post" id="form1"  enctype="multipart/form-data" name="form1" action="<? echo base_url() ?>melengkapi/add" >
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="txtcatatan" class="block col-sm-2 control-label">Catatan Melengkapi</label>
                   	<div class="col-sm-6">
                    		  <div class="input-group">
                       		 <textarea name="txtcatatan" class="form-control" cols="50" rows="5"> </textarea>
                    		 </div>
                    </div>
                </div> 
                <div class="form-group">
