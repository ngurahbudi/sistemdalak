  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>penjadwalan" >
              <div class="box-body">
                <div class="form-group">
                    <label for="txtkelurahan" class="block col-sm-2 control-label">Kegiatan</label>
                    	<div class="col-sm-6" >
                        	<select id="cbokegiatan" name="cbokegiatan" class="select2 "  data-placeholder="- Pilih -"  >  
								...
								<?    
                                        ...
                                        { 
                                ?>
                                        <option   value="<? echo $row['jenismonitoring_id']; ?>" <? if($row_filter['jenismonitoring_id']==$row['jenismonitoring_id']) echo "Selected" ?>    ><? echo $row['jenismonitoring'] ; ?></option>
                                     <? } ?>
							</select>
                    	</div>
                </div> 
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun" name="txttglturun" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tgljadwal1']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun2" name="txttglturun2" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tgljadwal2']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                </span>
                            </div>
          ...
          <div class="box  box-default">
            ...
            <div class="box-body table-responsive" id="boxlist"  >
              <table width="100%" class="table table-bordered table-striped table-hover" id="datatabel">
                ...
                <tr>
                  <th width="67">ID</th>
                  <th width="103">Tgl Turun</th>
                  <th width="241"> Perusahaan</th>
                  <th width="231"> Alamat Perusahaan</th>
                  <th width="133" align="center">No. Telp</th>
                  <th width="163" align="center">No. Ijin Prinsip</th>
                  <th width="121" align="center">Bidang Usaha</th>
                  <th width="47" align="center">Aksi</th>
                </tr>
                </thead>
                <tbody>
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['jadwal_id'] ; ?><br><span class="label <? echo $label ?>"><? echo $row['jenismonitoring_id']; ?></span></td>
                  ...
                  <td align="center"><? echo anchor('penjadwalan/edit/'.$row['jadwal_id']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('penjadwalan/delete/' .$row['jadwal_id'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                </tr>
                <?
