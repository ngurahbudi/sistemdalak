...
<body class="hold-transition skin-blue sidebar-mini" onLoad="txtpenjadwalan.focus()">
<div class="wrapper">
<?php
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-solid box-primary">
            ...
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>penjadwalan/edit" >
              <div class="box-body">
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun" name="txttglturun" value="<?  echo  $this->mycombo->FormatDMY($rowedit['jadwal_tgl']);  ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                    	...
                    	<div class="col-sm-6" >
                        	<select id="cbokegiatan" name="cbokegiatan" class="select2 "  data-placeholder="- Pilih -"  >  
								...
								<?    
                                        ...
                                        { 
                                ?>
                                        <option   value="<? echo $row['jenismonitoring_id']; ?>" <? if($rowedit['jenismonitoring_id']==$row['jenismonitoring_id']) echo "Selected" ?>    ><? echo $row['jenismonitoring'] ; ?></option>
                                     <? } ?>
							</select>
                    	</div>
                </div> 
