  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>pemantauan" >
              <div class="box-body">
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun" name="txttglturun" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tglturun']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun2" name="txttglturun2" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tglturun2']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                </span>
                            </div>
            ...
            <div class="box-body table-responsive" id="boxlist"  >
              <table width="100%" class="table table-bordered table-striped table-hover" id="datatabel">
                ...
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['monit_id'] ; ?><br><span class="label <? echo $label ?>"><? echo $row['jenismonitoring_id']; ?></span></td>
                  ...
                  <td align="center"><? echo anchor('pemantauan/edit/'.$row['jadwal_id'] ."/".$idmonit  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('pemantauan/delete/' .$row['prs_id']  ."/" .$idmonit , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                </tr>
                <?
