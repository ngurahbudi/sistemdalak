      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-solid box-primary">
            ...
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>kategory/edit" >
              <div class="box-body">
                <div class="form-group">
                  <label for="txtID" class="block col-sm-2 control-label">ID</label>
                  <div class="col-sm-4">
                    <input type="input" readonly class="form-control" name="txtID" id="txtID" value="<?  echo $rowedit['klasmasalah_id'];  ?>" placeholder="Auto ID">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                    <label for="txtKlasifikasi" class="block col-sm-2 control-label">Klasifikasi</label>
                    	<div class="col-sm-6">
                    		<span class="block  ">
                        		<input name="txtKlasifikasi"   type="text" class="form-control" id="txtKlasifikasi" value="<?  echo $rowedit['klasmasalah'];  ?>" placeholder="Klasifikasi" />
                    		</span>
                    	</div>
                    </label>
                </div> 
              ...
              <div class="box-footer">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input name="cmdBatal" type="button" value="Batal" id="cmdBatal" class="btn btn-info" onClick="window.location.replace('<? echo base_url() ?>kategory');">
                  </div>
                </div>
