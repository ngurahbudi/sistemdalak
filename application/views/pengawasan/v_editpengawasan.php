      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-solid box-primary">
            ...
            <form class="form-horizontal" method="post" id="form1" name="form1" enctype="multipart/form-data" action="<? echo base_url() ?>pengawasan/edit" >
              <div class="box-body">
                <div class="form-group">
                  <label for="txtpengawasan" class="block col-sm-2 control-label">ID</label>
                  <div class="col-sm-2">
              ...
              <div class="box-footer">
                  ...
                  <div class="col-sm-6">
                   <input name="cmdUpdate" type="submit" value="Update" id="cmdUpdate" class="btn btn-primary">
                    <input name="cmdBatal" type="button" value="Batal" id="cmdBatal" class="btn btn-info" onClick="window.location.replace('<? echo base_url() ?>pengawasan');">&nbsp;<a target="_blank" href="<? echo base_url("perusahaan/edit") . "/". $rowedit['prs_id'] ?>" class="btn btn-success" >Cek Data Perusahaan </a>
                  </div>
                </div>
