          ...
          <div class="box  box-default">
            ...
            <div class="box-body" id="boxlist" >
              <table width="" class="table table-bordered table-striped table-hover" id="datatabel">
                <thead>
                <tr>
                  <th width="70">Jalan ID</th>
                  <th width="337">Nama Jalan</th>
                ...
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['jalan_id']; ?></td>
                  <td><? echo $row['namajalan']; ?></td>
                  <td align="center"><? echo anchor('jalan/edit/'.$row['jalan_id']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('jalan/delete/' .$row['jalan_id'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                 </td>
