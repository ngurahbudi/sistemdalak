      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-solid box-primary">
            ...
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>jalan/edit" >
              <div class="box-body">
                <div class="form-group">
                  <label for="txtID" class="block col-sm-2 control-label">ID</label>
                  <div class="col-sm-4">
                    <input type="input" readonly class="form-control" name="txtID" id="txtID" value="<?  echo $rowedit['jalan_id'];  ?>" placeholder="Auto ID">
                  </div>
                </div>
  
                 <div class="form-group">
                    <label for="txtJalan" class="block col-sm-2 control-label">Nama Jalan</label>
                    	<div class="col-sm-6">
                    		<span class="block  ">
                        		<input name="txtJalan"   type="text" class="form-control" id="txtJalan" value="<?  echo $rowedit['namajalan'];  ?>" placeholder="Nama Jalan" />
                    		</span>
                    	</div>
                    </label>
                </div> 
              ...
              <div class="box-footer">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input name="cmdBatal" type="button" value="Batal" id="cmdBatal" class="btn btn-info" onClick="window.location.replace('<? echo base_url() ?>jalan');">
                  </div>
                </div>
