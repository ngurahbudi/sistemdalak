        ...
        <div class="col-xs-12">
          <div class="box  box-primary">
            ...
            <div class="box-body" id="boxadd"  >
            	 <!-- form start -->
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>jalan/add" >
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="txtJalan" class="block col-sm-2 control-label">Nama Jalan</label>
                    	<div class="col-sm-6">
                    		<span class="block  ">
                        		<input name="txtJalan"   type="text" class="form-control" id="txtJalan" placeholder="Nama Jalan" />
                    		</span>
                    	</div>
                    </label>
                </div> 
