          ...
          <div class="box  box-default">
            ...
            <div class="box-body" id="boxlist" >
              <table width="" class="table table-bordered table-striped table-hover" id="datatabel">
                <thead>
                <tr>
                  <th width="70">Group ID</th>
                  <th width="337">Nama Group</th>
                ...
                <? 
				 ...
				 ?>
                <tr>
                  <td><? echo $row['groupuser_id']; ?></td>
                  <td><? echo $row['groupuser']; ?></td>
                  <td align="center"><? echo anchor('groupuser/edit/'.$row['groupuser_id']  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('groupuser/delete/' .$row['groupuser_id'] , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                 </td>
