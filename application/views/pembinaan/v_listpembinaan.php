  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form class="form-horizontal" method="post" id="form1" name="form1" action="<? echo base_url() ?>pembinaan" >
              <div class="box-body">
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun" name="txttglturun" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tglpb1']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                ...
                <div class="form-group">
                      ...
                      <div class=" col-sm-2" >
                            <div class="input-group">
                                <input class="form-control date-picker" id="txttglturun2" name="txttglturun2" value="<?   echo $this->mycombo->FormatYMD($_SESSION['tglpb2']); ?>"  placeholder="dd-mm-yyyy" type="text" data-date-format="dd-mm-yyyy" />
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                </span>
                            </div>
            ...
            <div class="box-body table-responsive" id="boxlist"  >
              <table width="100%" class="table table-bordered table-striped table-hover" id="datatabel">
                ...
                <tr>
                  ...
                  <td align="center"><? echo anchor('pembinaan/edit/'.$row['jadwal_id'] ."/".$idmonit  , '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning tooltips" data-placement="top" data-original-title="Edit"') . ' 
                        '. anchor('pembinaan/delete/' .$row['prs_id']  ."/".$idmonit , '<i class="fa fa-trash"></i>',  'class="btn btn-xs btn-danger tooltips" data-placement="top" data-original-title="Edit"  onclick="return confirmDialog()"'  ) ; ?></td>
                </tr>
                <?
