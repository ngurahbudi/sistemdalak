<?
	class M_lappengawasan extends CI_model
	{
		public $namatabel;
		...
		public function SelectAllData($where="") 
		{
			...
			WHERE a.prs_id<>'0' and h.jenismonitoring_id='PS'  " . $where ;  
		...
		public function export($data,$status_filter="" ) 
		{
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('A1' , "LAPORAN pengawasan");
			...
			$objWriter->save('./lapexcell/Lap-pengawasan.xlsx'); 
	
			$this->load->helper('download');
			force_download('./lapexcell/Lap-pengawasan.xlsx', NULL);
		}
