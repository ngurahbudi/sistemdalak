<?
	class M_lappembinaan extends CI_model
	{
		public $namatabel;
		...
		public function export($data,$status_filter="" ) 
		{
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('A1' , "LAPORAN PEMBINAAN");
			...
			$objWriter->save('./lapexcell/Lap-pembinaan.xlsx'); 
	
			$this->load->helper('download');
			force_download('./lapexcell/Lap-pembinaan.xlsx', NULL);
		}
